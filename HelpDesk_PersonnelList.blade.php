			...
			function RunQuery(sql) //Function for running a query to the personnel table and getting building a table.
			{
				$.get("Query.php", {'sql':sql, 'returnData':true},function(json) //Calls query.php, which handles the SQL query and sorting of result data.
				{
					...
					{				
						...
						htm+="<th class='header' onclick='SortTable(1)' scope='col'>Name</th>";
						htm+="<th class='header' onclick='SortTable(2)'scope='col'>Job Title</th>";
						htm+="<th class='header' onclick='SortTable(3)'scope='col'>Department</th>";
						htm+="<th class='header' onclick='SortTable(4)'scope='col'>Telephone Number</th>";
						htm+="<th class='header' onclick='SortTable(5)'scope='col'>Specialist</th></tr>"; //Appending column headers.
