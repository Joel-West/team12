	...
	<head>
		...
		<script type="text/javascript">	
			...
			function UpdateRow() //Function that updates the selected row.
			{
				...
				if (!ListContains(updList, row.cells[0].innerHTML) && !row.cells[0].indexOf("(new)") != -1) //If selected row is not already marked to be updated when changes are saved to the database later and is not a new row.
				{
