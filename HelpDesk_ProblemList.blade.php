			...
			function RunQuery(sql) //Function for running a query to the personnel table and getting building a table.
			{
				$.get("Query.php", {'sql':sql, 'returnData':true},function(json) //Calls query.php, which handles the SQL query and sorting of result data.
				{
					...
					{				
						...
						htm+="<th onclick='SortTable(5)'scope='col'>Specialist</th>";
						htm+="<th onclick='SortTable(6)'scope='col'>Resolved</th>";
						htm+="<th onclick='SortTable(7)'scope='col'>Date/Time Resolved</th>";
						htm+="<th onclick='SortTable(8)'scope='col'>Solution</th></tr>"; //Appending column headers.
